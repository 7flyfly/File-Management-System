    ...
    FileInput.prototype = {
        ...
        _initTemplateDefaults: function () {
            ...
            tActions = '<div class="file-actions">\n' +
                ...
                '<div class="clearfix"></div>';
            //noinspection HtmlUnknownAttribute
            //hidden 删除小的上传和删除按钮 修改源码 --xuxin--20190512
            tActionDelete = '<button type="button" class="kv-file-remove hidden {removeClass}" ' +
                'title="{removeTitle}" {dataUrl}{dataKey}>{removeIcon}</button>\n';
            tActionUpload = '<button type="button" class="kv-file-upload  hidden {uploadClass} " title="{uploadTitle}">' +
                '{uploadIcon}</button>';
